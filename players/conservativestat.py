...
# Plays dice game conservatively based on probability strategies
class ConservativeStat(Player):
    ...
    # Only increases the quantity if the previous dice number is
    # greater than the current player's most common dice number.
    # Typically returns the player's most common dice number.
    def getMove(
        self,
        prevMoves: list[tuple[tuple[Player, str], int, int]],
        currentPlayer: str,
